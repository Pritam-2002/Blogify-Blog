        ...
        <div class="flex flex-col sm:flex-row mt-10">
          <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
            <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
              <img className=' h-full w-full rounded-full' src='https://pbs.twimg.com/profile_images/1678614891387838464/BFM47V0F_400x400.jpg'/>
            </div>
            <div class="flex flex-col items-center text-center justify-center">
              <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Pritam Mukherjee</h2>
              <div class="w-12 h-1 bg-[#3d348b] rounded mt-2 mb-4"></div>
...
{/* <section className="flex justify-center items-center">
  ...
  >
    <img  className=' h-80 w-80' src='https://imgs.search.brave.com/AenEPiymI_GJlaSTKy83mdnsERa23RciiUuMNYjZ09E/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9wbmdp/bWcuY29tL3VwbG9h/ZHMvbGlua2VkSW4v/c21hbGwvbGlua2Vk/SW5fUE5HMjEucG5n'/>
