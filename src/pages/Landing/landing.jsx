...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
    ...
    <div className="text-center lg:w-2/3 w-full">
      ...
      <p className="mb-8 text-base font-medium leading-relaxed px-10">Create and grow your developer blog, newsletter, or team engineering blog effortlessly with Blogify. Level up your writing using powerful AI features!</p>
