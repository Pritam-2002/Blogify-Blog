...
<section class="py-10 relative bg-white sm:py-16 lg:py-24 lg:pt-36 mt-3">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-center  ">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-2xl font-light text-black sm:text-4xl sm:leading-tight">The go-to platform for top developers from leading companies.
            </h2>
        </div>
